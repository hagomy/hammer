...
//        mAdapter.getItem(position)
    ...
    fun addItem() {
        ...
        mAdapter.addItem(Goods("FJARMA", "바깥쪽 주머니에 열쇠와 휴대폰 등을 넣어두면 보다 편리하게 사용할 수 있어요. 가방 아래쪽 칸에는 신발 등을 넣을 수 있습니다.", 39900, true , User("user"),
                ArrayList<Int>().apply {
                    add(R.drawable.a_0)
                    add(R.drawable.a_1)
                    add(R.drawable.a_2)
        ...
        mAdapter.addItem(Goods("FJARMA", "바깥쪽 주머니에 열쇠와 휴대폰 등을 넣어두면 보다 편리하게 사용할 수 있어요. 가방 아래쪽 칸에는 신발 등을 넣을 수 있습니다.", 49900, false , User("user"),
                ArrayList<Int>().apply {
                    add(R.drawable.b_0)
                    add(R.drawable.b_1)
                    add(R.drawable.b_2)
        ...
        mAdapter.addItem(Goods("KNALLA", "세탁물과 식료품, 재활용품까지 무엇이든 담을 수 있습니다. 지퍼식 제품으로 가방을 떨어뜨려도 내용물이 쏟아지지 않습니다.", 2900, false , User("user"),
                ArrayList<Int>().apply {
                    add(R.drawable.c_0)
                    add(R.drawable.c_1)
                }))
        mAdapter.addItem(Goods("FÖRENKLA", "바깥쪽 주머니에 열쇠와 휴대폰 등을 넣어두면 보다 편리하게 사용할 수 있어요. 슈트케이스의 손잡이에 쉽게 걸어둘 수 있어서 여행을 다닐 때 특히 더 편리합니다.", 29900, true , User("user"),
                ArrayList<Int>().apply {
                    add(R.drawable.d_0)
                    add(R.drawable.d_1)
                    add(R.drawable.d_2)
        ...
        mAdapter.addItem(Goods("FÖRENKLA", "바깥쪽 주머니에 열쇠와 휴대폰 등을 넣어두면 보다 편리하게 사용할 수 있어요. 슈트케이스의 손잡이에 쉽게 걸어둘 수 있어서 여행을 다닐 때 특히 더 편리합니다.", 29900, false , User("user"),
                ArrayList<Int>().apply {
                    add(R.drawable.e_0)
                    add(R.drawable.e_1)
                    add(R.drawable.e_2)
